    ...
    return <div>
        ...
        <div
            ...
            <div className="flex justify-start gap-3 items-center">
                ...
                <Headline className="text-5xl" variant={"h1"}>KIT Vorlesungsbingo</Headline>
            </div>
            <div className="my-4 mb-6 text-left sm:my-8">
                <Headline variant="h2" className="mb-2 text-black">
            ...
            <div className="flex gap-4">
                <div>
                    <Button onClick={() => navigate("/modules")}
                            className="bg-gray-800 px-10 py-6 text-xl rounded-xl font-bold">
                        Loslegen!
                    </Button>
                </div>
